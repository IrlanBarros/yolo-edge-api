...
from schemas import ( 
    ...
    BatchPredictRequest, BatchPredictResponse, HealthResponse, MetricsResponse, Detection 
) 
...
def _run_inference(image_np: np.ndarray, model_name: str, 
confidence: float) -> PredictResponse: 
...
@app.post("/predict/image", responses={200: {"content": 
{"image/jpeg": {}}}}) 
...
async def get_metrics(): 
    avg = (_metrics["total_ms"] / _metrics["success"] if 
_metrics["success"] > 0 else 0.0) 
